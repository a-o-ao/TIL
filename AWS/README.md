...
| リソース名 | 概要 |
| ------------- | --------------------------------------------------------------- |
| CodeCommit | Gitリポジトリ管理サービス。 |
| CodeBuild | 継続的インテグレーション（CI）サービス。 |
| CodeDeploy | 自動デプロイサービス。 |
| CodePipeline | CI/CDパイプライン管理サービス。 |
| Cloud9 | クラウドベースのIDE環境。 |
